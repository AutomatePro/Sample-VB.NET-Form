Public Class EyeOPD_Form
    ...
    Private Sub cmd_Load_Combo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Read.Click
        ...
        patientsDT = myEyeOPD_Data_Connector.execute_query("SELECT JKCRegNum, FirstName FROM [EyeOPD].[dbo].[Patients] ORDER BY 1;")

        If patientsDT.Rows.Count <> 0 Then

            cmb_Patients.DataSource = patientsDT
            cmb_Patients.DisplayMember = "FirstName"
    ...
    Private Sub btn_Update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Update.Click
        ...
        If JKP_Reg_Num > 0 Then
            ...
            Dim rowsUpdated As Integer = myEyeOPD_Data_Connector.execute_action_query(query, parameters)
    ...
    Private Sub btn_Create_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Create.Click
        ...
        If IsNumeric(Me.tb_JKC_Reg_Number.Text) = True Then
    ...
    Private Sub cmb_Patients_SelectedValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmb_Patients.SelectedValueChanged
        If IsNumeric(CType(cmb_Patients.SelectedItem, DataRowView)("JKCRegNum").ToString()) = True Then
